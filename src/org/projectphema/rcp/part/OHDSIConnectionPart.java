...
public class OHDSIConnectionPart {
	...
	public void setFocus() {
		...
		//System.out.println("dissetFocuspose");
	}
	...
	public static void setName(String textName) {
		OHDSIConnectionPart.textName.setText(textName);
	}

	public static void setURL(String textUrl) {
		OHDSIConnectionPart.textUrl.setText(textUrl);
	}

	public static void setUser(String textUser) {
		OHDSIConnectionPart.textUser.setText(textUser);
	}

	public static void setPassword(String textPass) {
		OHDSIConnectionPart.textPass.setText(textPass);
	}

	public static void setProject(String textProject) {
		OHDSIConnectionPart.textProject.setText(textProject);
	}

	public static void setDomain(String textDomain) {
		OHDSIConnectionPart.textDomain.setText(textDomain);
	}
